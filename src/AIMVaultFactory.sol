...
import {AIMVault} from "./AIMVault.sol";
...
contract AIMVaultFactory is Owned {
    ...
    event VaultDeployed(AIMVault vault, ERC20 underlying, address cToken);
    ...
    function isVaultDeployed(AIMVault vault) external view returns (bool) {
